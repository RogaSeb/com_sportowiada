...
use Joomla\CMS\Form\Form; // Importowanie klasy Form
use Joomla\CMS\MVC\Model\FormModelInterface; // Importowanie interfejsu FormModelInterface

class DisciplineModel extends AdminModel implements FormModelInterface
{
    protected $text_prefix = 'COM_SPORTOWIADA';
    ...
    public function check()
    {
        ...
        $this->alias = OutputFilter::stringURLSafe($this->alias); // Poprawiono wywołanie
    ...
    public function getTable($name = 'Discipline', $prefix = 'Table', $options = array())
    {
        return $this->_createTable($name, $prefix, $options);
    }
}
